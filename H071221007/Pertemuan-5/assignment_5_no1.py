...
list1 = [int (input ("Input nilai matrks Pertama indeks 1,1 :")),
int (input ("Input nilai matrks Pertama indeks 1,2 :")),
int (input ("Input nilai matrks Pertama indeks 2,1 :")),
int (input ("Input nilai matrks Pertama indeks 2,2 :"))]

list2 = [int (input ("Input nilai matrks Kedua indeks 1,1 :")),
int (input ("Input nilai matrks Kedua indeks 1,2 :")),
int (input ("Input nilai matrks Kedua indeks 2,1 :")), 
int (input ("Input nilai matrks Kedua indeks 2,2 :"))]
